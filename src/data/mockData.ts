...
export const mockAgents: Agent[] = [
  ...
  { id: 'a5', name: 'Ayush', activeLeads: 0, totalLeads: 0, avgResponseTime: 0, conversions: 0, visitsScheduled: 0 },
  { id: 'a6', name: 'Satvik', activeLeads: 0, totalLeads: 0, avgResponseTime: 0, conversions: 0, visitsScheduled: 0 },
  { id: 'a7', name: 'Nayana', activeLeads: 0, totalLeads: 0, avgResponseTime: 0, conversions: 0, visitsScheduled: 0 },
];
