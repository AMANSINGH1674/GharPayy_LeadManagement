    ...
    validProps.forEach(p => {
      ...
      const popupContent = `
        <div style="font-family:Inter,sans-serif;min-width:200px;padding:4px;">
          ${p.photos?.[0] || (p as any).previewLink ? `<img src="${p.photos?.[0] || (p as any).previewLink}" style="width:100%;height:120px;object-fit:cover;border-radius:8px;margin-bottom:8px;" />` : ''}
